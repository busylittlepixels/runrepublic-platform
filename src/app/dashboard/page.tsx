...
import { stripCalOAuthClientIdFromEmail } from "@/__cal/utils";
      ...
      <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
        ...
        <Card x-chunk="dashboard-05-chunk-1">
          <CardHeader className="pb-2">
            ...
            <Link href={`/categories/latest`}>Latest</Link>
            <CardTitle className="text-4xl">BALLS</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card x-chunk="dashboard-05-chunk-2">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-4xl">FLoop</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-xs text-muted-foreground">
              sdfad
